    ...
    <section class="content">
      <form action="index.php?controller=account&action=store" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-12">
                ...
                <?php if (isset($mess)) {
                  if ($mess === true) { ?>
                    <div class="col-md-10 mx-auto alert alert-success alert-block">
                      ...
                      <strong>Bạn đã tạo tài khoản thành công</strong>
                    </div>
                    <?php } else {
        ...
        <div class="row">
          <div class="col-12">
            ...
            <input type="submit" value="Tạo tài khoản" class="btn btn-success float-right">
          </div>
        </div>
      </form>
    </section>